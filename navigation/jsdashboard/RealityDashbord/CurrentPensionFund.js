...
const CurrentPensionFund = ({ ctxData, name, budget, user, showEditModal, type }) => {
    ...
    <>
      ...
      <View style={styles.cardUsers}>
        <View style={styles.cardConteent}>
          <Text style={{ fontSize: 17, color: myColorsLight.grey3 }}>
            Desire Retirement{"\n"} Lifestyle Monthly spend
          </Text>
        </View>
        <View style={{ ...styles.cardConteent, width: 150 }}>
          {/* <Text style={{ fontWeight: "bold" }}>
            £{user?.attributes?.currentValue}
          </Text> */}
          <TextInput style={styles.input} value="£2776" />
          <TouchableOpacity
...
export default CurrentPensionFund;
