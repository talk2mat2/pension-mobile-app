...
const RealityIncomeUsers = ({ ctxData, name, budget, user, showEditModal }) => {
    ...
    <>
      ...
      <View style={styles.cardUsers}>
        ...
        <View style={{ ...styles.cardConteent, width: 150 }}>
          ...
          <TextInput style={styles.input} value="£128,9909" />
          <TouchableOpacity
...
export default RealityIncomeUsers;
