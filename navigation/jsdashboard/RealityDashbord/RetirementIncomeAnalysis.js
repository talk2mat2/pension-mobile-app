...
const RetirementIncomeAnalysis = ({ handleshowCards }) => {
        ...
        >
          ...
          >
            <TouchableOpacity onPress={closeCard}>
              <Text style={styles.cardName}>Retirement Income Analysis</Text>
            </TouchableOpacity>
            {!rtisfullScreen ? (
          ...
          <Text style={{ textAlign: "center", fontSize: 30, marginTop: 90 }}>
            TBD
          </Text>
        </View>
...
export default RetirementIncomeAnalysis;
