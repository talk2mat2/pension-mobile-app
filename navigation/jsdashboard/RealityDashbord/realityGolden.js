...
const RealityGolden = ({ handleshowCards }) => {
        ...
        >
          ...
          >
            <TouchableOpacity onPress={closeCard}>
              <Text style={styles.cardName}>Golden Number Comparison</Text>
            </TouchableOpacity>
            {!rtisfullScreen ? (
          ...
          <View style={{ marginTop: 40, maxHeight: 400 }}>
            <ScrollView style={{}}>
