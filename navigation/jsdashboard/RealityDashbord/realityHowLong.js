...
const RealityHowLong = ({ handleshowCards }) => {
        ...
        >
          ...
          >
            <TouchableOpacity onPress={closeCard}>
              <Text style={styles.cardName}>How Long Money Will Last?</Text>
            </TouchableOpacity>
            {!rtisfullScreen ? (
          ...
          >
            <Text style={{ textAlign: "center", color: myColorsLight.grey3,paddingTop:10 }}>
              The number of years your current{"\n"}
              Pension Fund will last based on{"\n"}
